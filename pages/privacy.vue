...
export default {
  ...
  data() {
    return {
      ...
      body: `
<p>
  At Perguidex, accessible from https://perguidex.io, one of our main priorities
  is the privacy of our visitors. This Privacy Policy document contains types of
  information that is collected and recorded by Perguidex and how we use it.
</p>
...
<p>
  ...
  and/or collect in Perguidex.

<h2 class="text-h4">Consent</h2>
...
<h2 class="text-h5">Information we collect</h2>
...
<h2 class="text-h5">How we use your information</h2>
...
<h2 class="text-h5">Log Files</h2>

<p>
  Perguidex follows a standard procedure of using log files. These files log
...
<h2 class="text-h5">Cookies and Web Beacons</h2>

<p>
  Like any other website, Perguidex uses 'cookies'. These cookies are used to
...
<h2 class="text-h5">Advertising Partners Privacy Policies</h2>

<p>
  You may consult this list to find the Privacy Policy for each of the
  advertising partners of Perguidex.
</p>

<p>
  Third-party ad servers or ad networks uses technologies like cookies,
  JavaScript, or Web Beacons that are used in their respective advertisements
  and links that appear on Perguidex, which are sent directly to users' browser.
...
<p>
  Note that Perguidex has no access to or control over these cookies that are
  used by third-party advertisers.
</p>

<h2 class="text-h5">Third Party Privacy Policies</h2>

<p>
  Perguidex's Privacy Policy does not apply to other advertisers or websites.
...
<h2 class="text-h5">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>
...
<h2 class="text-h5">GDPR Data Protection Rights</h2>
...
<h2 class="text-h5">Children's Information</h2>
...
<p>
  Perguidex does not knowingly collect any Personal Identifiable Information
  ...
  information from our records.
      ...
      `,
      title: 'Privacy Policy for Perguidex'
