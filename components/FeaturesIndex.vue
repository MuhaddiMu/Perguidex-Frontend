        ...
        <v-card-text class="svg-background">
          <v-row column wrap>
            <v-col class="text-center my-5" cols="12" sm="12" xl="12">
              <div
                class="grey--text text--darken-4 font-weight-regular display-2"
              >
                Your Best Benefit
              </div>
            </v-col>
                  ...
                  <v-card flat class="transparent">
                    ...
                    <v-card-title primary-title class="layout justify-center">
                      <div class="headline text-center">
                        Activities
                        <v-chip label x-small color="primary"> New </v-chip>
                      </div>
                    </v-card-title>
                    <v-divider
                      role="presentation"
                    ...
                    ></v-divider>
                    <v-card-text
                      class="text-center grey--text text--darken-4 font-weight-regular"
                    >
        ...
        <v-card-text>
          <v-row align="center" justify="center" class="my-5">
            <v-col cols="12" sm="10" class="text-center">
              <div
                class="grey--text text--darken-4 font-weight-regular display-2 text-center"
              >
                Sync Perguidex with your life
              </div>
              <div class="mt-5 grey--text text--darken-4 font-weight-regular">
